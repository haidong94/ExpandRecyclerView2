...
//            default:
//            case CHILD_NORMAL:
//                ingredientView = mInflater.inflate(R.layout.recipe_view, childViewGroup, false);
//                break;
//            case CHILD_VEGETARIAN:
//                ingredientView = mInflater.inflate(R.layout.vegetarian_recipe_view, childViewGroup, false);
//                break;
//        }
        ingredientView = mInflater.inflate(R.layout.vegetarian_recipe_view, childViewGroup, false);
    ...
    public void onBindChildViewHolder(@NonNull IngredientViewHolder ingredientViewHolder, int parentPosition, int childPosition, @NonNull Ingredient ingredient) {
        ingredientViewHolder.bind(ingredient.getName());
    }
//
//    @Override
